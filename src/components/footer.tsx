    ...
    <footer className="border-t border-hairline-soft bg-surface/40">
      <div className="mx-auto max-w-6xl px-6 py-16">
        ...
        <div className="mt-14 rounded-xl border border-hairline-soft bg-void/50 p-4 text-xs leading-relaxed text-text-faint">
          ...
          results. Trading involves substantial risk of loss and is not suitable
          for every investor — only trade with capital you can afford to lose.
          See our{" "}
          <Link
            href="/terms"
            className="underline decoration-hairline underline-offset-2 hover:text-text-primary"
          >
            Terms of Use
          </Link>{" "}
          for details.
