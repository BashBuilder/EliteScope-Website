export const siteConfig = {
  ...
  url: "https://elitescope.app", // TODO: replace with your real production domain
  ...
  playStoreUrl: "https://play.google.com/store/apps/details?id=com.thimmy.sample",
  ...
  company: {
    legalName: "[Your Company Legal Name]", // e.g. "Elite Scope Technologies, Inc."
    address: "[Company Registered Address]",
    jurisdiction: "[Governing State/Country, e.g. Delaware, USA]",
...
export const tiers = [
  {
    ...
    capabilities: ["Core signals across active pairs", "Signal direction & timeframe", "Confidence scoring"],
  },
  {
    id: "strategist",
    name: "Strategist",
    ...
    capabilities: ["Everything in Explorer", "Advanced indicators", "Entry, stop-loss & take-profit levels"],
    featured: true,
  },
  {
    id: "mathematician",
    ...
    capabilities: ["Everything in Strategist", "Structured analytics", "Analyst notes on every signal"],
  },
];
