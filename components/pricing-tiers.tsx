  ...
  return (
    <section id="pricing" className="mx-auto max-w-6xl px-6 py-24">
      <div className="flex flex-col items-start justify-between gap-6 md:flex-row md:items-end">
        <div className="max-w-xl">
          ...
          <p className="mt-4 text-text-muted">
            Each tier includes everything below it. Start where you are,
            upgrade in the app whenever you need more depth.
          </p>
        </div>
            ...
            >
              ...
              <ul className="mt-6 flex-1 space-y-3">
                {tier.capabilities.map((cap) => (
                  <li key={cap} className="flex items-start gap-2.5 text-sm text-text-muted">
                    <svg
      ...
      <p className="mt-8 text-xs text-text-faint">
        ...
        <a href="/subscription-terms" className="underline decoration-hairline underline-offset-2 hover:text-text-muted">
          Subscription Terms
        </a>{" "}
        for full details.
      </p>
